...
const sections = [
  {
    ...
    items: [
      ...
      { slug: 'usage', label: 'Usage Guide', file: 'usage.md' },
      { slug: 'build_and_test', label: 'Build & Test', file: 'build_and_test.md' },
    ],
  },
  {
    group: 'API',
    ...
    items: [
      ...
      { slug: 'python_bindings', label: 'Python Bindings', file: 'python_bindings.md' },
      { slug: 'c_api_guide', label: 'C API Guide', file: 'c_api_guide.md' },
      { slug: 'api_keys_required', label: 'API Keys', file: 'api_keys_required.md' },
    ],
  },
  {
    group: 'Architecture',
    ...
    items: [
      ...
      { slug: 'performance', label: 'Performance', file: 'performance.md' },
      { slug: 'deployment', label: 'Deployment', file: 'deployment.md' },
      { slug: 'security', label: 'Security', file: 'security.md' },
    ],
  },
  {
    group: 'Examples',
  ...
  },
  {
    ...
    icon: '\u2764',
    items: [
      { slug: 'troubleshooting', label: 'Troubleshooting', file: 'troubleshooting.md' },
    ],
  },
]
